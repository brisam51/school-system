...
@section('content')
    ...
    <div class="card" style="background-color: grey; color:antiquewhite">
        ...
        <div class="card-body">
            ...
            <form action="{{ url('admin/teacher/insert') }}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="row">
                    <div class="col">
                        ...
                        <div class="form-group">
                            ...
                            <select  name="gender" class="form-control">
                                ...
                                <option {{ old('gender') ? 'selected' : '' }} value="other">Others</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status">
                                ...
                                <option {{ old('status') == '0' ? 'selected' : '' }} value="0">Avtive</option>
                                <option {{ old('status') == '1' ? 'selected' : '' }} value="1">Inavtive</option>
